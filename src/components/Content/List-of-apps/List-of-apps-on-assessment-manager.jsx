...
const ListOfAppsOnAssessmentManager = () => {
    ...
    const showHideNewApp = () => {
        let newAppShadow = document.getElementById("newAppShadow");
        let newApp = document.getElementById("newApp");
        if (newAppShadow.style.maxHeight) {
            newAppShadow.style.maxHeight = null;
            newApp.style.maxHeight = null;
        } else {
            newAppShadow.style.maxHeight = 99999 + 'px';
            newApp.style.maxHeight = 99999 + 'px';
        }
    }
    ...
    return (
        <div>
            <div className={Styles.mainTitle}>
                <button className={s.btnAdd} onClick={showHideNewApp}>
                    ...
                    <form action="">
                        <div className={s.newApp}>
                            <div className={s.newTitleContainer}>
                                ...
                                <button className={s.newRejectClose} onClick={showHideNewApp}><img src={del} className={s.newCloseImg} /></button>
                            </div>
                            ...
                            <div>
                                ...
                                <div className={s.newItem}>
                                    <button className={s.btnGreen} onClick={showHideNewApp}>Создать</button>
                                </div>
                            </div>
                        </div>
                    </form>
